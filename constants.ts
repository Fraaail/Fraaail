...
export const LINKEDIN_LINK =
  "https://ph.linkedin.com/in/keayon-ivan-romero-59571418a";
...
export const PROJECTS: Project[] = [
  {
    ...
    name: "Dace-Website",
    description:
      "A responsive single-page website for Dace's Samgyeopsal, implemented with React, Vite, and TypeScript.",
  ...
  },
  {
    ...
    name: "SPLWD",
    description:
      "SPLWD: Student Profiling for Learners with Disabilities in Sta. Cruz District of Laguna.",
  ...
  },
  {
    ...
    description:
      "A Windows Forms (.NET Framework 4.8) application for tracking CCS students and their achievements.",
  ...
  },
  {
    ...
    description:
      "A simple Tkinter GUI for browsing short, consistent information about dog and cat breeds.",
...
export const FILES: Record<string, string> = {
  ...
  "skills.txt":
    "Python, Laravel, Go, Windows, Linux, Hyprland, Docker, UI/UX Design",
  "contact.json":
