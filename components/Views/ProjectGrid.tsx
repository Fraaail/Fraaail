              ...
              <div className="p-6 flex flex-col h-full justify-between bg-neutral-900/20 group-hover:bg-purple-900/10 transition-colors">
                <div>
                  <div className="flex justify-between items-start mb-4">
                    <Folder
                      size={32}
                      className="text-neutral-600 group-hover:text-purple-400 transition-colors"
                    />
                ...
                <div>
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.techStack.map((tech) => (
                      <span
                        key={tech}
                        className="px-2 py-1 bg-black text-purple-200 text-xs rounded border border-purple-900/30"
                      >
                        {tech}
                      </span>
                    ))}
                  ...
                  <a
                    ...
                    className="flex items-center gap-2 text-sm text-neutral-500 hover:text-white transition-colors group/link"
                  >
                    View Source{" "}
                    <ArrowRight
                      size={14}
                      className="text-purple-500 group-hover/link:translate-x-1 transition-transform"
                    />
                  </a>
                </div>
              </div>
