...
export const TerminalHero: React.FC = () => {
  ...
  const handleCommand = (e: React.FormEvent) => {
    ...
    const newHistory = [
      ...history,
      { type: "command", content: input } as TerminalLine,
    ];
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-full p-2 md:p-4">
      ...
      <WindowFrame
        ...
        isActive={true}
        className="md:col-span-1 border-purple-500"
      >
        <div className="p-8 flex flex-col justify-center h-full space-y-8 bg-[#0a0a0a]">
          <div>
            ...
            <p className="text-neutral-400 text-lg md:text-xl font-light">
              ...
              <span className="text-white italic">feels</span> like magic.
            </p>
          </div>

          <div className="space-y-4 text-neutral-300 border-l-4 border-purple-500 pl-6 py-2">
            <p className="leading-relaxed">
              A Computer Science Student specializing in Python, Laravel, and OS
              Management. I create applications that helps local clients,
              businesses and for personal projects.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            <a
              ...
              className="flex items-center gap-2 px-6 py-3 bg-white text-black font-bold rounded hover:bg-purple-100 transition-colors"
            >
              <Github size={20} />
              <span>GitHub</span>
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-6 py-3 border border-neutral-700 hover:border-purple-500 hover:text-purple-400 transition-colors rounded text-neutral-300"
            >
              <Linkedin size={20} />
              <span>LinkedIn</span>
            </a>
      ...
      <WindowFrame
        title="Alacritty - zsh"
        className="md:col-span-1 bg-[#050505]"
        isActive={false}
      >
        <div
          className="p-4 font-mono text-sm h-full flex flex-col overflow-hidden"
          onClick={focusInput}
        >
            ...
            {history.map((line, i) => (
              <div key={i} className="break-words">
                {line.type === "command" ? (
                  ...
                  <div className="text-neutral-400 whitespace-pre-wrap pl-6">
                    {line.content}
                  </div>
                )}
              </div>
