...
export const StatsView: React.FC = () => {
      ...
      >
        <div className="p-6 h-full flex flex-col bg-[#0a0a0a]">
          ...
          <div className="mt-4 grid grid-cols-3 gap-4 text-xs font-mono text-neutral-500 border-t border-neutral-800 pt-4">
            ...
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-purple-500"></div> Uptime:
              4d 2h
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-blue-500"></div> Load:
              0.42
            </div>
          </div>
        </div>
 ...
 /_-''    ''-_\\`}</pre>
            ...
            <div className="space-y-1 text-xs sm:text-sm">
              <div>
                <span className="text-purple-400 font-bold">fraaail</span>@
                <span className="text-white font-bold">arch</span>
              </div>
              <div className="text-neutral-600">----------------</div>
              <div>
                <span className="text-purple-400 font-bold">OS</span>: Arch
                Linux x86_64
              </div>
              <div>
              ...
              <div>
                <span className="text-purple-400 font-bold">Kernel</span>:
                6.6.7-arch1-1
              </div>
              <div>
                <span className="text-purple-400 font-bold">Shell</span>: zsh
                5.9
              </div>
              <div>
                <span className="text-purple-400 font-bold">WM</span>: Hyprland
              </div>
              <div>
